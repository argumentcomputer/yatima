...
--   (N . 1) 
--   (XS . 
--     <FUNCTION (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733) 
--       (NAT_BRECON (LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733) NIL) _FUN_DISCR__40_INIT_PRELUDE__HYG_2733 (LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733 F _FUN_DISCR__40_INIT_PRELUDE__HYG_2732) (NAT_ADD_MATCH_1 (LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2732_2745 _FUN_DISCR__40_INIT_PRELUDE__HYG_2733_2746) NIL) _FUN_DISCR__40_INIT_PRELUDE__HYG_2732 _FUN_DISCR__40_INIT_PRELUDE__HYG_2733 (LAMBDA (A X__40_INIT_PRELUDE__HYG_2768) A) (LAMBDA (A B X__40_INIT_PRELUDE__HYG_2768) (NAT_SUCC (PPROD_FST ((LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733) NIL) B) (NAT_REC (LAMBDA (_T) NIL) PUNIT (LAMBDA (N N_IH) (PPROD (PPROD ((LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733) NIL) N) N_IH) PUNIT)) B) (PPROD_FST (PPROD ((LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733) NIL) B) (NAT_REC (LAMBDA (_T) NIL) PUNIT (LAMBDA (N N_IH) (PPROD (PPROD ((LAMBDA (_FUN_DISCR__40_INIT_PRELUDE__HYG_2733) NIL) N) N_IH) PUNIT)) B)) PUNIT X__40_INIT_PRELUDE__HYG_2768) A))) F)) _FUN_DISCR__40_INIT_PRELUDE__HYG_2732))>) 
--   ((GETELEM . 
--     <FUNCTION (XS) (LAMBDA (N) 
