...
structure UnivCid  (k : Kind) where data : Lurk.F deriving BEq, Ord, Repr
structure ExprCid  (k : Kind) where data : Lurk.F deriving BEq, Ord, Repr
structure ConstCid (k : Kind) where data : Lurk.F deriving BEq, Ord, Repr
